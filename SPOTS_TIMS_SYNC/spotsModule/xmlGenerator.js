    ...
    function privateGenerateSummons( rs, summonsCount, sql ) {
    	...
    	if (rs.length>0) {
			...
			do 
			{
				...
				if (rs[x].vehicleColourCode) xw.startElement('vehicleColourCode').text(rs[x].vehicleColourCode).endElement();
				if (rs[x].vehicleColourDescription) xw.startElement('vehicleColourDescription').text(rs[x].vehicleColourDescription).endElement();
