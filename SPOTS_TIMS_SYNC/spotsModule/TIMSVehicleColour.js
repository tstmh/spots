...
module.exports = (function(){
    ...
    const TABLENAME = 'tims_vehicle_color', PK_FIELD = 'code';
    ...
    async function publicUpdateDB(resolve,reject) {
        ...
        xw = new xmlack();
        xw.createXML('spotsVehicleColourCodeAcknowledgement');
        ...
        xw.writeAckXML( 'spots_vehicle_colour_code', false ); 
    ...
    function publicSetXMLNodes(allNodes) {
        ...
        logger.info("SetXMLNodes TIMSVehicleColourCode is finished");
    }
