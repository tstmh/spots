...
module.exports = (function(){
    ...
    const TABLENAME = 'tims_vehicle_type', PK_FIELD = 'code';
    ...
    async function publicUpdateDB(resolve, reject) {
        ...
        xw = new xmlack();
        xw.createXML('spotsVehicleTypeCodeAcknowledgement');
        ...
        xw.writeAckXML( 'spots_vehicle_type_code', false);
    ...
    function publicSetXMLNodes(allNodes) {
        ...
        logger.info("SetXMLNodes TIMSVehicleType is finished");
    }
