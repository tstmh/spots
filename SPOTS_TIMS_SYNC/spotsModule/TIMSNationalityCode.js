...
module.exports = (function(){
    ...
    const TABLENAME = 'tims_nationality_code', PK_FIELD = 'code';
    ...
    async function publicUpdateDB(resolve,reject) {
        ...
        xw = new xmlack();
        xw.createXML('spotsNationalityCodeAcknowledgement');
        ...
        xw.writeAckXML( 'spots_nationality_code', false ); 
    ...
    function publicSetXMLNodes(allNodes) {
        ...
        logger.info("SetXMLNodes TIMSNationalityCode is finished");
    }
