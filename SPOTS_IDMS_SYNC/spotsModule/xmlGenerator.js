        ...
        function privateGenerateSummons( rs, summonsCount, sql ) {
            ...
            do 
            {
                ...
                if (memSummonsType==rs[x].summonsType) {
                    ...
                    if (memSummonsType==1) {
                        if (memID===isnull(rs[x].offenderIDNumber)) {
                            bGenerateTIMS = 0;
                        } else {
                            bGenerateTIMS = 1;
                        }
                    } else if (memSummonsType==2) {
                        if (memID===isnull(rs[x].vehicleNumber)) {                      
                            bGenerateTIMS = 0;
                        } else {
                            bGenerateTIMS = 1;
                        }
                ...
                if (rs[x].vehicleNumber) xw.startElement('vehicleNumber').text(rs[x].vehicleNumber).endElement();
                ...
                if (rs[x].vehicleCategory) xw.startElement('vehicleCategory').text(rs[x].vehicleCategory).endElement();
                if (rs[x].vehicleTransmission) xw.startElement('vehicleTransmission').text(rs[x].vehicleTransmission).endElement();
                if (rs[x].vehicleMake) xw.startElement('vehicleMake').text(rs[x].vehicleMake).endElement();
                ...
                if (rs[x].buildingName) xw.startElement('buildingName').text(isnull(rs[x].buildingName)).endElement();
                ...
                if (rs[x].reportRemarks) xw.startElement('reportRemarks').text(rs[x].reportRemarks).endElement();
                ...
                while ( (x < rs.length) && (memSummonsType==rs[x].summonsType ) &&
                    (   ( (memSummonsType==1) && (memID === isnull(rs[x].offenderIDNumber) ) ) || 
                ...
                for (var s=(totalOffence); s>0; s--) {
                    ...
                    xw.startElement('offenceRemarks').text(isnull(rs[x - s].offenceRemarks)).endElement();
                    xw.endElement();
