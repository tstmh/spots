            ...
            <View style={styles.AccordionFrame} >
                <View style={styles.FullFrame}>
                    ...
                    <TextInput
                        ...
                        value={pedestrianName}
                        onChangeText={text => setPedestrianName(text)}
                    />
                </View>
                ...
                <View style={styles.FullFrame}>
                    <Text>
                        <Text style={styles.Label}> Injury/Condition </Text>
                    ...
                    <View style={styles.TextInputWrapper}>
                        <TextInput
                            ...
                            maxLength={255}
                        />
                        <Text style={styles.CharCounter}>{injury?.length}/255</Text>
                    </View>
                </View>
...
export default PedestrianIdentity;
