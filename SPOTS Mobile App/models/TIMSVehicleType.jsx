export default class TIMSVehicleType {
    static tableName = "tims_vehicle_type";
    static timsVehicleType = [];
    ...
    static fromRow(row) {
        return new TIMSVehicleType(row.code, row.description, row.created, row.modified, row.delete_flag, row.sequence);
    }
    ...
    static async getTIMSVehicleType(db) {
      console.log("getTIMSVehicleType");
          ...
          db.transaction(tx => {
              tx.executeSql(
                  ...
                  (tx, results) => {
                      ...
                      //console.log("getTIMSVehicleType >> results: ", rows);
                      ...
                      //console.log("getTIMSVehicleType >> ", list);
                      resolve(list);
                  },
                  (tx, error) => {
                      console.error("Error executing getTIMSVehicleType SQL query:", error);
                      reject(error);
                  }
              );
          });
