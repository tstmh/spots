export default class TIMSVehicleColor {
    static tableName = "tims_vehicle_color";
    static timsVehicleColor = []
    ...
    static fromRow(row) {
        return new TIMSVehicleColor(row.code, row.description, row.created, row.modified, row.delete_flag, row.sequence);
    }
    ...
    static async getTIMSVehicleColor(db) {
      console.log("getTIMSVehicleColor");
          ...
          db.transaction(tx => {
              tx.executeSql(
                  ...
                  (tx, results) => {
                      ...
                      //console.log("getTIMSVehicleColor >> results: ", rows);
                      ...
                      //console.log("getTIMSVehicleColor >> ", list);
                      resolve(list);
                  },
                  (tx, error) => {
                      console.error("Error executing getTIMSVehicleColor SQL query:", error);
                      reject(error);
                  }
              );
          });
